...
import com.teach.datalibrary.LessonComment;
import com.teach.frame10.design.RoundImage;
import com.teach.teach10zl.R;
import com.teach.teach10zl.tools.SpanUtils;
import com.teach.teach10zl.view.customs.AutoLineFeedLayout;
import com.teach.teach10zl.view.customs.CenterAlignImageSpan;
import com.teach.teach10zl.view.customs.RatingBar;
...
public class CourseDescribeAdapter extends RecyclerView.Adapter<CourseDescribeAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (comment.getReplycontent() != null && comment.getReplycontent().size() > 0) {
            ...
            spannable.setSpan(new ForegroundColorSpan(ContextCompat.getColor(mContext, R.color.appThemeRed)), 3, 6, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
