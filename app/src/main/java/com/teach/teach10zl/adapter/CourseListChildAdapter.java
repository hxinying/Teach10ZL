...
import com.teach.datalibrary.LessonPartEntity;
import com.teach.teach10zl.R;
import com.teach.teach10zl.interfaces.OnRecyclerItemClickListener;
import com.teach.teach10zl.view.customs.DownLoadRoundProgressBar;
...
public class CourseListChildAdapter extends RecyclerView.Adapter<CourseListChildAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvPartName.setMaxWidth(entity.IsDome()?dp2px(220):dp2px(260));
