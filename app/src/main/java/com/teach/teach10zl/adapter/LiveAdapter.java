...
import com.teach.datalibrary.LiveDataInfo;
...
private OnRecyclerItemClickListener onRecyclerItemClickListener;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holderPre, int position) {
        holderPre.itemView.setOnClickListener(v ->{
            if (onRecyclerItemClickListener!=null)onRecyclerItemClickListener.onItemClick(position);
        });
